# AI Maths Tutor with MathPix (Enhanced Version)
...
✅ Hides raw extracted maths text from pupils  
✅ Adds a `settings.json` file to toggle debug mode (no need to edit code)  
✅ Provides fallback: if no structured sections detected, shows full AI feedback
